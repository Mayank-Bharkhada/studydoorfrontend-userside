...
const CreateAccountForStudent = () => {
  const [loading, setLoading] = useState(false);
  const navigation = useNavigation();
  const [isEnabled, setIsEnabled] = useState(false);
  const setButtonEnabled = () => {
    if (email != null && fullName != null && number != null && DateOfBirth != null && password != null && address != null && city != null && state != null && country != null && pincode != null) {
      setIsEnabled(true);
    } else {
      setIsEnabled(false);
    }
  ...
  const [DateOfBirthShow, setdateOfBirthShow] = useState();
  ...
  const createStudentAccount = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${Links.Domain}/api/User/Student_Otp`, {
        method: 'POST',
        headers: {
  ...
  return (
              ...
              <View style={styles.mainContainer}>
                <View style={styles.inputContainer}>
                  ...
                  <Input
                    ...
                    errorMessage="Full name only contail alphabats"
                  />
                  ...
                  />
                  <TouchableOpacity style={styles.loginButton} onPress={() => { createStudentAccount() }} disabled={!isEnabled} >
                  ...
                  <View style={{ flexDirection: "row", alignSelf: "center" }}>
                    ...
                    <Text style={{ color: "#0247fe" }} onPress={() => { navigation.navigate("StudentLogin") }} > Login account</Text>
                  </View>
                </View>
              </View>
            )}
      ...
      export default CreateAccountForStudent
